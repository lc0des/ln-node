...
# run the container
docker run  -d --restart=always --name=$dc-th --net=$dc-net --ip=$th_ip -p 127.0.0.1:3000:3000/tcp -v $dc-vol-th:/app/data/ --env=NO_VERSION_CHECK:"true" --LOG_LEVEL:"debug" --env=CONFIG_PATH:/app/data/th.yaml $dc-th
